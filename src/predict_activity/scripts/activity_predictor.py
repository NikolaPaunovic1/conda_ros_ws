...
class ImuDataPredictor:
    ...
    def __init__(self, model_path):
        ...
        self.pub = rospy.Publisher('/activity_label', Int8, queue_size=1)
    ...
    def callback(self, data):
        ...
        # Perform prediction - uncomment additional code to log prediction time

        # start_time = rospy.get_time()
        output = self.model(data_array)
        # end_time = rospy.get_time()
        # rospy.loginfo("Time taken for prediction: %s", end_time - start_time)
...
if __name__ == '__main__':
    predictor = ImuDataPredictor("/home/nikola/Watch_Data/Models/model_tools_real_1.pt")
